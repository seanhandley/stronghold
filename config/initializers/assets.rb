...
Rails.application.config.assets.precompile += %w( includes/common.js )
Rails.application.config.assets.precompile += %w( includes/card_animations.js )
Rails.application.config.assets.precompile += %w( includes/password_score.js )
Rails.application.config.assets.precompile += %w( includes/angular.js )
