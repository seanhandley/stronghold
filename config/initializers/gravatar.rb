GravatarImageTag.configure do |config|
  config.default_image           = 'http://s13.postimg.org/bs9ffsmhz/default_user.png' # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
