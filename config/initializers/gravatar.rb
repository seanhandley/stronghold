GravatarImageTag.configure do |config|
  config.default_image           = 'https://assets-cdn.datacentred.io/assets/default_user.png' # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
  ...
  config.size                    = 30   # Set this to globally set the size of the gravatar image returned (1..512). Gravatar's default is 80
