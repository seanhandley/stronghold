...
class TicketAdapter
  ...
  class << self
    ...
    def departments
      Rails.cache.fetch("stronghold_departments", expires_in: 1.day.from_now.to_time.to_i) do
    ...
    def priorities
      Rails.cache.fetch("stronghold_priorities", expires_in: 1.day.from_now.to_time.to_i) do
