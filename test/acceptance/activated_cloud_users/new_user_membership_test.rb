...
class NewUserMembershipTests < CapybaraTestCase
  ...
  def setup
    @organization1 = Organization.make!(name: 'test-organization1')
    @organization2 = Organization.make!(name: 'test-organization2')
    @user = User.make!(organizations: [@organization1])
