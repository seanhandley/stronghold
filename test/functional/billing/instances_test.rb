...
class InstancesTest < Minitest::Test
  ...
  def test_inactive_machines_dont_incur_charges
    assert_equal 3, Billing::Instances.usage(@test_tenant.uuid, Time.parse('2014-11-21 14:00:00'), Time.parse('2014-11-21 15:00:00')).count
    # All three instances were terminates before 15:00
    assert_equal 0, Billing::Instances.usage(@test_tenant.uuid, Time.parse('2014-11-21 15:00:00'), Time.parse('2014-11-21 15:30:00')).count
  end
  ...
  def test_machines_on_steady_incur_full_usage
      ...
      usage = Billing::Instances.usage(@test_tenant.uuid, Time.parse('2014-11-21 16:10:00'), Time.parse('2014-11-21 17:15:00'))
