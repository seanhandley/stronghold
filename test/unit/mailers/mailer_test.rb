...
class MailerTest < ActionMailer::TestCase
  ...
  def usage_report_data
    [{:name=>"DataCentred", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"test@test.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"test@test.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"foo@bar.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"foo@bar.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"DataCentred Development", :contacts=>["sean.handley@datacentred.co.uk", "foo@bar.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}, {:name=>"sean.handley+test40@gmail.com", :contacts=>["sean.handley+test40@gmail.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}, {:name=>"sean.handley+freeze@gmail.com", :contacts=>["sean.handley+freeze@gmail.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}, {:name=>"test@test.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"foo@bazbar.com", :contacts=>["foo@bazbar.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}, {:name=>"sean.handley+foo@gmail.com", :contacts=>["sean.handley+foo@gmail.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}, {:name=>"sean.handley+barfs@gmail.com", :contacts=>[], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>false, :spend=>0}, {:name=>"sean.handley+dsf@gmail.com", :contacts=>["sean.handley+dsf@gmail.com"], :vcpu_hours=>0.0, :ram_tb_hours=>0.0, :openstack_tb_hours=>0, :ceph_tb_hours=>0.0, :paying=>true, :spend=>0}]
  end
